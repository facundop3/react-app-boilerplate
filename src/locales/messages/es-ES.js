export default {
  common: {
    ...
    forgotPasswordLegend:
      'Paso 1: Escribe tu email y te ayudaremos a recuperar tu contraseña',
    goBackHome: 'Volver al inicio',
    invalidEmail: 'Email inválido',
    invalidToken: 'El código ingresado no es válido',
    lastName: 'Apellido',
    lengthToken: 'Debe tener cinco dígitos',
    locale: 'Idioma',
    ...
    resetPasswordSuccess: 'Se ha actualizado la contraseña correctamente',
